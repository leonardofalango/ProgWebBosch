...
print(f'A array original:\n{array}') # Printando o  array inicial

#colocanhdo a condição
impares = array % 2 != 0
array[impares] = 0 # Alterando os valores que sao impares, para 0
print(f'A array substituindo os números ímpares por 0: \n{array}') # Printando o array com as substituições
